    ...
    return (
      <div className="carousel">
        <div className="carousel_img">
          <ReactCSSTransitionGroup transitionName="carousel" transitionEnterTimeout={1000} transitionLeaveTimeout={1000}>
            <img src={this.state.imgs[this.state.currentIndex]} key={this.state.imgs[this.state.currentIndex]} />
